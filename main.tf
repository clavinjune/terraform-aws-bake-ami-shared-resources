module "codebuild_role" {
  source = "github.com/traveloka/terraform-aws-iam-role.git//modules/service?ref=v4.0.1"
...
module "codepipeline_artifact_bucket_name" {
  source = "github.com/traveloka/terraform-aws-resource-naming?ref=v0.20.0"
